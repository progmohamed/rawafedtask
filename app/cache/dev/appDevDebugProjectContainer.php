...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'task_posts.form.post.postform' => 'getTaskPosts_Form_Post_PostformService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'rawafedtech', 'user' => 'root', 'password' => NULL, 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_73b0dfe5ed30e6225fc7b7811b8f659a');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_73b0dfe5ed30e6225fc7b7811b8f659a');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_73b0dfe5ed30e6225fc7b7811b8f659a');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Task\\PostsBundle\\Entity'))), 'Task\\PostsBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TaskPostsBundle' => 'Task\\PostsBundle\\Entity'));
    ...
    /**
     * Gets the 'task_posts.form.post.postform' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Task\PostsBundle\Form\Post\PostForm A Task\PostsBundle\Form\Post\PostForm instance.
     */
    protected function getTaskPosts_Form_Post_PostformService()
    {
        return $this->services['task_posts.form.post.postform'] = new \Task\PostsBundle\Form\Post\PostForm();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Task\\PostsBundle/Resources/views'), 'TaskPosts');
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'))), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => ($this->targetDirs[3].'\\src\\Task\\PostsBundle\\Resources\\config\\validation.yml'))))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TaskPostsBundle' => 'Task\\PostsBundle\\TaskPostsBundle',
            ...
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => ($this->targetDirs[3].'\\src\\Task\\PostsBundle\\Resources\\config\\validation.yml'),
            ),
