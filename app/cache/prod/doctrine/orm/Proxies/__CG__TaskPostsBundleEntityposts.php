...
namespace Proxies\__CG__\Task\PostsBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class posts extends \Task\PostsBundle\Entity\posts implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Task\\PostsBundle\\Entity\\posts' . "\0" . 'id', '' . "\0" . 'Task\\PostsBundle\\Entity\\posts' . "\0" . 'title', '' . "\0" . 'Task\\PostsBundle\\Entity\\posts' . "\0" . 'content', '' . "\0" . 'Task\\PostsBundle\\Entity\\posts' . "\0" . 'categoryID', '' . "\0" . 'Task\\PostsBundle\\Entity\\posts' . "\0" . 'publishDate');
        }
