 ...
 */
class categories extends \Task\PostsBundle\Entity\categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Task\\PostsBundle\\Entity\\categories' . "\0" . 'id', '' . "\0" . 'Task\\PostsBundle\\Entity\\categories' . "\0" . 'name', '' . "\0" . 'Task\\PostsBundle\\Entity\\categories' . "\0" . 'posts');
        }
